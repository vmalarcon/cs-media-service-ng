    ...
    public List<Map<String, String>> validateImages(List<ImageMessage> messageList) {
        ...
        for (final ImageMessage imageMessage : messageList) {
            ...
            if (imageMessage.getOuterDomainData() != null) {
                if (imageMessage.getOuterDomainData().getDomainId() == null || !skuGroupCatalogItemDao.skuGroupExists(Integer.parseInt(imageMessage.getOuterDomainData().getDomainId()))) {
                ...
                if (imageMessage.getOuterDomainData().getDomainId() != null && !roomTypeDao.roomTypeCatalogItemIdExists(imageMessage.getOuterDomainData())) {
