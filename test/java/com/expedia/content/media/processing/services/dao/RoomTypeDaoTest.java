...
public class RoomTypeDaoTest {
    ...
    @Mock
    RoomTypeThirdPartyGet sprocThirdParty;
    ...
    public void initialize() {
        ...
        roomTypeDao = new RoomTypeDao(sproc, sprocThirdParty);
    }
    ...
    public void testRoomTypeIdExists() {
        ...
        when(sprocThirdParty.getRooms(anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(mockRoomResultsThirdParty);
        ...
        verify(sprocThirdParty, times(1)).getRooms(anyInt(), anyInt(), anyInt(), anyInt());
    }
